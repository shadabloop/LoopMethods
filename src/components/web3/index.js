    ...
    return (
        <>
                    ...
                    <div className={styled.bannerWrapper}>
                        <div className={styled.banner}>
                            <div className={styled.leftPanel}>
                                <h1 className={styled.title}><span>Web 3.0</span> Development</h1>
                                <p className={styled.discription}>We develop interactive web3 solutions using blockchain, AI, IoT, and cryptography. Our experts in web3 tools, Rust, and Solidity serve industries from gaming to real estate and fintech.</p>
                            ...
                            <div className={styled.rightPanel} data-aos="fade-up" data-aos-duration="700">
                                <Image 
                                    src="https://frequencyimage.s3.ap-south-1.amazonaws.com/4525348b-cc15-45b7-a954-ab279ed81a70-cybersecurity-analyst-robotics-engineer-illustration.jpg"
                                    width={0}
                                    height={0}
                                    sizes="100vw"
                                />
            ...
            <section className={styled.AI_Models_Wrapper}>
                <div className="container">
                    <h2 className={styled.heading} data-aos="fade-up" data-aos-duration="700">The WeB 3 Stack</h2>

                    <div className={styled.tabContainer}>
                        <ul className={styled.tabList} ref={scrollRef} data-aos="fade-up" data-aos-duration="700">
                            {
                        ...
                        <div className={styled.ai_service_wrapper}>
                            {
                                AiModal.filter((val => val.name === isActiveTab))[0]?.cardData?.map((item, key) => (
                                    <li className={styled.brand} data-aos="fade-up" data-aos-duration="700">
                                        <Image src={item.url} width={60} height={60} />
                                        <h5 className={styled.title}>{item.title}</h5>
                                    </li>
                                ))
