    ...
    return (
        <>
                    ...
                    <div className={styled.bannerWrapper}>
                        <div className={styled.banner}>
                            <div className={styled.leftPanel}>
                                <h1 data-swiper-parallax="50%" className={styled.title}>Get in Touch</h1>
                                <p data-swiper-parallax="50%" className={styled.discription}>We'd love to hear from you! Whether you have a question, need a consultation, or want to discuss a project, our team is ready to assist. Reach out to us today to explore how our innovative solutions can help your business thrive.</p>
            ...
            <section className={styled.ContactUs_development_wrapper}>
                <div className="container">
                    <p className={styled.smallTitle}>Why contact us.</p>
                    <h2 className={styled.heading}>Let's collaborate to bring your vision to life. </h2>
            ...
            <section className={styled.founder_section}>
                <div className="container">
                    <div className={styled.founder_wrapper}>
                        <small className={styled.small}>Little bit more </small>
                        <h4 className={styled.title}>Meet Our Founder.</h4>
                        <Image src="https://images.pexels.com/photos/7793140/pexels-photo-7793140.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" className={styled.profile} width={228} height={228} />
                        <h6 className={styled.owner_name}>Mr. Rajesh Rishi</h6>
                        <p className={styled.designation}>Chief Executive Officer</p>
