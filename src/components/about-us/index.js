    ...
    return (
        <>
            ...
            <section className={styled.AboutUs_development_wrapper}>
                ...
                <div className="container">
                    <p className={styled.title}>Our Mission</p>
                    <h2 className={styled.description}>Loop methods is dedicated to revolutionizing the IT industry through custom application development, Android application expertise, QA as a service, and Web 3.0. Our goal is to provide unparalleled solutions that empower businesses to efficiently and effectively achieve their digital transformation objectives.</h2>

                    <p className={styled.title}>Our Vision</p>
                    <h2 className={styled.description}>We are committed to creating a future where technology seamlessly integrates with businesses to drive innovation and sustainable global growth. Through continuous learning and adaptation, we are determined to lead in shaping the digital landscape.</h2>
                </div>
            </section>
            <section className={styled.Our_Journey_Wrapper}>
                <div className="container">
                    <h2 className={styled.title}>Our Journey</h2>

                    <div className={styled.timeline}>
                        <div className={`${styled.container_timeline} ${styled.left}`}>
                            <div className={styled.content}>
                                <h2 className={styled.heading}>2009</h2>
                                <p className={styled.description}>Lorem ipsum dolor sit amet consectetur. Quisque nibh pulvinar metus nunc vivamus pharetra lacus. Cum rhoncus egestas quis leo rhoncus tristique enim malesuada. Dignissim et a metus nec. Nunc laoreet enim volutpat molestie.</p>
                            </div>
                        </div>
                        <div className={`${styled.container_timeline} ${styled.right}`}>
                            <div className={styled.content}>
                                <h2 className={styled.heading}>2016</h2>
                                <p className={styled.description}>Lorem ipsum dolor sit amet consectetur. Quisque nibh pulvinar metus nunc vivamus pharetra lacus. Cum rhoncus egestas quis leo rhoncus tristique enim malesuada. Dignissim et a metus nec. Nunc laoreet enim volutpat molestie.</p>
                            </div>
                        </div>
                        <div className={`${styled.container_timeline} ${styled.left}`}>
                            <div className={styled.content}>
                                <h2 className={styled.heading}>2015</h2>
                                <p className={styled.description}>Lorem ipsum dolor sit amet consectetur. Quisque nibh pulvinar metus nunc vivamus pharetra lacus. Cum rhoncus egestas quis leo rhoncus tristique enim malesuada. Dignissim et a metus nec. Nunc laoreet enim volutpat molestie.</p>
                            </div>
                        </div>
                    </div>
