    ...
    return (
        <>
            <section className={styled.swipperWrapper}>
                <div className="container">
                    <Swiper
                        ...
                        autoplay={{
                            delay: 2500, // 5 seconds for demo purposes
            ...
            <section className={styled.PowerfulSolutionWrapper}>
                <div className="container">
                    <h5 className={styled.mainTital} data-aos="fade-up" data-aos-duration="700">solution for every industry</h5>
                    <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">A Powerful solutions engineered for global businesses.</h2>
                    <p className={styled.paragraph} data-aos="fade-up" data-aos-duration="900">With enough data, the numbers speak for themselves.</p>
                ...
                <div className="container">
                    <div className={styled.graphWrap}>
                        ...
                        <Image
                            ...
                            src="https://frequencyimage.s3.ap-south-1.amazonaws.com/45bc68ed-3576-4963-96f6-024b6575ffbe-graph1.png"
            ...
            <section className={styled.ProcessOfWorkingWrapper}>
                <div className="container">
                    <h2 className={styled.title} data-aos="fade-up" data-aos-duration="700">Process of working </h2>

                    <div className={styled.tabContainer}>
                        <ul className={styled.tabList} data-aos="fade-up" data-aos-duration="800">
                            {
                    ...
                    <div className={styled.whyChoseUs}>
                        ...
                        <div className={styled.rightPanel}>
                            <div className={styled.card}>
                                <h4 className={styled.count} data-aos="fade-up" data-aos-duration="700">01.</h4>
                                <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">Industry Expertise </h2>
                                <p className={styled.description} data-aos="fade-up" data-aos-duration="900">With years of experience delivering custom solutions across multiple industries, we bring deep domain knowledge to understand your unique business challenges and craft tailored applications that drive efficiency and competitiveness.</p>
                            </div>
                            <div className={styled.card}>
                                <h4 className={styled.count} data-aos="fade-up" data-aos-duration="700">02.</h4>
                                <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">Cutting-Edge Technology </h2>
                                <p className={styled.description} data-aos="fade-up" data-aos-duration="900">With years of experience delivering custom solutions across multiple industries, we bring deep domain knowledge to understand your unique business challenges and craft tailored applications that drive efficiency and competitiveness.</p>
                            </div>
                            <div className={styled.card}>
                                <h4 className={styled.count} data-aos="fade-up" data-aos-duration="700">03.</h4>
                                <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">User-Centric Design</h2>
                                <p className={styled.description} data-aos="fade-up" data-aos-duration="900">We prioritize user experience, employing user-centered design principles and usability testing to develop intuitive, engaging applications that boost productivity and user adoption.</p>
                            </div>
                            <div className={styled.card}>
                                <h4 className={styled.count} data-aos="fade-up" data-aos-duration="700">04.</h4>
                                <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">Agile Collaboration</h2>
                                <p className={styled.description} data-aos="fade-up" data-aos-duration="900">Through our agile development approach, we foster close collaboration with your team, ensuring applications align with your evolving needs and market dynamics.</p>
                            </div>
                            <div className={styled.card}>
                                <h4 className={styled.count} data-aos="fade-up" data-aos-duration="700">05.</h4>
                                <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">Robust Security</h2>
                                <p className={styled.description} data-aos="fade-up" data-aos-duration="900">Robust Security: Security is at the core of our development process, with stringent secure coding practices, data protection measures, and compliance with industry regulations, safeguarding your critical applications and data.</p>
                            </div>
                            <div className={styled.card}>
                                <h4 className={styled.countTitle} data-aos="fade-up" data-aos-duration="700">Need  more ?</h4>
                                <h2 className={styled.title} data-aos="fade-up" data-aos-duration="800">See Some Case Studies </h2>
                                <Image
                                    data-aos="fade-up" data-aos-duration="900"
